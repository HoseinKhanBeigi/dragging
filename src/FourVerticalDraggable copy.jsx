  ...
  return (
    ...
    >
      {boxes.map((y, i) => {
        ...
        const z = -stackRank * 54 * closedDepth;
        const rotateX = -stackRank * 1.5 * closedDepth;
        const closedPeek = isStackCard ? stackRank * 28 * closedDepth : 0;
        const closedScale = isStackCard
          ? 1 - stackRank * 0.055 * closedDepth
          : 1;
        ...
        return (
          <div
            ...
            style={{
              ...
              zIndex: activeIndex === i ? BOX_COUNT + 1 : BOX_COUNT - stackRank,
            }}
          >
            Box {i + 1}
          </div>
